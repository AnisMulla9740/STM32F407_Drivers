...
/*********************  Cortex-M4 Processor NVIC ISER Registers  *****************/
#define NVIC_ISER0     ((__VO uint32_t*)0xE000E100)
#define NVIC_ISER1     ((__VO uint32_t*)0xE000E104)
#define NVIC_ISER2     ((__VO uint32_t*)0xE000E108)
#define NVIC_ISER3     ((__VO uint32_t*)0xE000E10C)

/*********************  Cortex-M4 Processor NVIC ICER Registers  *****************/
#define NVIC_ICER0     ((__VO uint32_t*)0xE000E180)
#define NVIC_ICER1     ((__VO uint32_t*)0xE000E184)
#define NVIC_ICER2     ((__VO uint32_t*)0xE000E188)
#define NVIC_ICER3     ((__VO uint32_t*)0xE000E18C)

/*********************  Cortex-M4 Processor NVIC Priority Registers  *************/
...
typedef struct
{
	__VO uint32_t TIR;  /*!< CAN TX mailbox identifier register */
	__VO uint32_t TDTR; /*!< CAN mailbox data length control and time stamp register */
	__VO uint32_t TDLR; /*!< CAN mailbox data low register */
	__VO uint32_t TDHR; /*!< CAN mailbox data high register */
...
typedef struct
{
	__VO uint32_t RIR;  /*!< CAN receive FIFO mailbox identifier register */
	__VO uint32_t RDTR; /*!< CAN receive FIFO mailbox data length control and time stamp register */
	__VO uint32_t RDLR; /*!< CAN receive FIFO mailbox data low register */
	__VO uint32_t RDHR; /*!< CAN receive FIFO mailbox data high register */
...
typedef struct
{
	__VO uint32_t FR1; /*!< CAN Filter bank register 1 */
	__VO uint32_t FR2; /*!< CAN Filter bank register 1 */
...
typedef struct
{
	__VO uint32_t              MCR;                 /*!< CAN master control register,         Address offset: 0x00          */
	__VO uint32_t              MSR;                 /*!< CAN master status register,          Address offset: 0x04          */
	__VO uint32_t              TSR;                 /*!< CAN transmit status register,        Address offset: 0x08          */
	__VO uint32_t              RF0R;                /*!< CAN receive FIFO 0 register,         Address offset: 0x0C          */
	__VO uint32_t              RF1R;                /*!< CAN receive FIFO 1 register,         Address offset: 0x10          */
	__VO uint32_t              IER;                 /*!< CAN interrupt enable register,       Address offset: 0x14          */
	__VO uint32_t              ESR;                 /*!< CAN error status register,           Address offset: 0x18          */
	__VO uint32_t              BTR;                 /*!< CAN bit timing register,             Address offset: 0x1C          */
  uint32_t                   RESERVED0[88];       /*!< Reserved, 0x020 - 0x17F                                            */
  CAN_TxMailBox_TypeDef      sTxMailBox[3];       /*!< CAN Tx MailBox,                      Address offset: 0x180 - 0x1AC */
  CAN_FIFOMailBox_TypeDef    sFIFOMailBox[2];     /*!< CAN FIFO MailBox,                    Address offset: 0x1B0 - 0x1CC */
  uint32_t                   RESERVED1[12];       /*!< Reserved, 0x1D0 - 0x1FF                                            */
  __VO uint32_t              FMR;                 /*!< CAN filter master register,          Address offset: 0x200         */
  __VO uint32_t              FM1R;                /*!< CAN filter mode register,            Address offset: 0x204         */
  uint32_t                   RESERVED2;           /*!< Reserved, 0x208                                                    */
  __VO uint32_t              FS1R;                /*!< CAN filter scale register,           Address offset: 0x20C         */
  uint32_t                   RESERVED3;           /*!< Reserved, 0x210                                                    */
  __VO uint32_t              FFA1R;               /*!< CAN filter FIFO assignment register, Address offset: 0x214         */
  uint32_t                   RESERVED4;           /*!< Reserved, 0x218                                                    */
  __VO uint32_t              FA1R;                /*!< CAN filter activation register,      Address offset: 0x21C         */
...
typedef struct
{
	__VO uint32_t DR;         /*!< CRC Data register,             Address offset: 0x00 */
	__VO uint8_t  IDR;        /*!< CRC Independent data register, Address offset: 0x04 */
  uint8_t       RESERVED0;  /*!< Reserved, 0x05                                      */
  uint16_t      RESERVED1;  /*!< Reserved, 0x06                                      */
  __VO uint32_t CR;         /*!< CRC Control register,          Address offset: 0x08 */
} CRC_TypeDef;
...
typedef struct
{
	...
	__VO uint32_t DHR12R1;  /*!< DAC channel1 12-bit right-aligned data holding register, Address offset: 0x08 */
	__VO uint32_t DHR12L1;  /*!< DAC channel1 12-bit left aligned data holding register,  Address offset: 0x0C */
	__VO uint32_t DHR8R1;   /*!< DAC channel1 8-bit right aligned data holding register,  Address offset: 0x10 */
	__VO uint32_t DHR12R2;  /*!< DAC channel2 12-bit right aligned data holding register, Address offset: 0x14 */
	__VO uint32_t DHR12L2;  /*!< DAC channel2 12-bit left aligned data holding register,  Address offset: 0x18 */
	__VO uint32_t DHR8R2;   /*!< DAC channel2 8-bit right-aligned data holding register,  Address offset: 0x1C */
	...
	__VO uint32_t DOR1;     /*!< DAC channel1 data output register,                       Address offset: 0x2C */
	__VO uint32_t DOR2;     /*!< DAC channel2 data output register,                       Address offset: 0x30 */
...
typedef struct
{
	__VO uint32_t IDCODE;  /*!< MCU device ID code,               Address offset: 0x00 */
	__VO uint32_t CR;      /*!< Debug MCU configuration register, Address offset: 0x04 */
	__VO uint32_t APB1FZ;  /*!< Debug MCU APB1 freeze register,   Address offset: 0x08 */
	__VO uint32_t APB2FZ;  /*!< Debug MCU APB2 freeze register,   Address offset: 0x0C */
}DBGMCU_TypeDef;
...
typedef struct
{
	__VO uint32_t CR;       /*!< DCMI control register 1,                       Address offset: 0x00 */
	__VO uint32_t SR;       /*!< DCMI status register,                          Address offset: 0x04 */
	__VO uint32_t RISR;     /*!< DCMI raw interrupt status register,            Address offset: 0x08 */
	__VO uint32_t IER;      /*!< DCMI interrupt enable register,                Address offset: 0x0C */
	__VO uint32_t MISR;     /*!< DCMI masked interrupt status register,         Address offset: 0x10 */
	__VO uint32_t ICR;      /*!< DCMI interrupt clear register,                 Address offset: 0x14 */
	__VO uint32_t ESCR;     /*!< DCMI embedded synchronization code register,   Address offset: 0x18 */
	__VO uint32_t ESUR;     /*!< DCMI embedded synchronization unmask register, Address offset: 0x1C */
	__VO uint32_t CWSTRTR;  /*!< DCMI crop window start,                        Address offset: 0x20 */
	__VO uint32_t CWSIZER;  /*!< DCMI crop window size,                         Address offset: 0x24 */
	__VO uint32_t DR;       /*!< DCMI data register,                            Address offset: 0x28 */
} DCMI_TypeDef;
...
//{
//  __VO uint32_t MACCR;
//  __VO uint32_t MACFFR;
//  __VO uint32_t MACHTHR;
//  __VO uint32_t MACHTLR;
//  __VO uint32_t MACMIIAR;
//  __VO uint32_t MACMIIDR;
//  __VO uint32_t MACFCR;
//  __VO uint32_t MACVLANTR;             /*    8 */
//  uint32_t      RESERVED0[2];
//  __VO uint32_t MACRWUFFR;             /*   11 */
//  __VO uint32_t MACPMTCSR;
//  uint32_t      RESERVED1[2];
//  __VO uint32_t MACSR;                 /*   15 */
//  __VO uint32_t MACIMR;
//  __VO uint32_t MACA0HR;
//  __VO uint32_t MACA0LR;
//  __VO uint32_t MACA1HR;
//  __VO uint32_t MACA1LR;
//  __VO uint32_t MACA2HR;
//  __VO uint32_t MACA2LR;
//  __VO uint32_t MACA3HR;
//  __VO uint32_t MACA3LR;               /*   24 */
//  uint32_t      RESERVED2[40];
//  __VO uint32_t MMCCR;                 /*   65 */
//  __VO uint32_t MMCRIR;
//  __VO uint32_t MMCTIR;
//  __VO uint32_t MMCRIMR;
//  __VO uint32_t MMCTIMR;               /*   69 */
//  uint32_t      RESERVED3[14];
//  __VO uint32_t MMCTGFSCCR;            /*   84 */
//  __VO uint32_t MMCTGFMSCCR;
//  uint32_t      RESERVED4[5];
//  __VO uint32_t MMCTGFCR;
//  uint32_t      RESERVED5[10];
//  __VO uint32_t MMCRFCECR;
//  __VO uint32_t MMCRFAECR;
//  uint32_t      RESERVED6[10];
//  __VO uint32_t MMCRGUFCR;
//  uint32_t      RESERVED7[334];
//  __VO uint32_t PTPTSCR;
//  __VO uint32_t PTPSSIR;
//  __VO uint32_t PTPTSHR;
//  __VO uint32_t PTPTSLR;
//  __VO uint32_t PTPTSHUR;
//  __VO uint32_t PTPTSLUR;
//  __VO uint32_t PTPTSAR;
//  __VO uint32_t PTPTTHR;
//  __VO uint32_t PTPTTLR;
//  __VO uint32_t RESERVED8;
//  __VO uint32_t PTPTSSR;
//  uint32_t      RESERVED9[565];
//  __VO uint32_t DMABMR;
//  __VO uint32_t DMATPDR;
//  __VO uint32_t DMARPDR;
//  __VO uint32_t DMARDLAR;
//  __VO uint32_t DMATDLAR;
//  __VO uint32_t DMASR;
//  __VO uint32_t DMAOMR;
//  __VO uint32_t DMAIER;
//  __VO uint32_t DMAMFBOCR;
//  __VO uint32_t DMARSWTR;
//  uint32_t      RESERVED10[8];
//  __VO uint32_t DMACHTDR;
//  __VO uint32_t DMACHRDR;
//  __VO uint32_t DMACHTBAR;
//  __VO uint32_t DMACHRBAR;
//} ETH_TypeDef;
...
typedef struct
{
	__VO uint32_t BTCR[8];    /*!< NOR/PSRAM chip-select control register(BCR) and chip-select timing register(BTR), Address offset: 0x00-1C */
} FSMC_Bank1_TypeDef;
...
typedef struct
{
	__VO uint32_t BWTR[7];    /*!< NOR/PSRAM write timing registers, Address offset: 0x104-0x11C */
} FSMC_Bank1E_TypeDef;
...
typedef struct
{
	__VO uint32_t PCR2;       /*!< NAND Flash control register 2,                       Address offset: 0x60 */
	__VO uint32_t SR2;        /*!< NAND Flash FIFO status and interrupt register 2,     Address offset: 0x64 */
	__VO uint32_t PMEM2;      /*!< NAND Flash Common memory space timing register 2,    Address offset: 0x68 */
	__VO uint32_t PATT2;      /*!< NAND Flash Attribute memory space timing register 2, Address offset: 0x6C */
  uint32_t      RESERVED0;  /*!< Reserved, 0x70                                                            */
  __VO uint32_t ECCR2;      /*!< NAND Flash ECC result registers 2,                   Address offset: 0x74 */
  uint32_t      RESERVED1;  /*!< Reserved, 0x78                                                            */
  uint32_t      RESERVED2;  /*!< Reserved, 0x7C                                                            */
  __VO uint32_t PCR3;       /*!< NAND Flash control register 3,                       Address offset: 0x80 */
  __VO uint32_t SR3;        /*!< NAND Flash FIFO status and interrupt register 3,     Address offset: 0x84 */
  __VO uint32_t PMEM3;      /*!< NAND Flash Common memory space timing register 3,    Address offset: 0x88 */
  __VO uint32_t PATT3;      /*!< NAND Flash Attribute memory space timing register 3, Address offset: 0x8C */
  uint32_t      RESERVED3;  /*!< Reserved, 0x90                                                            */
  __VO uint32_t ECCR3;      /*!< NAND Flash ECC result registers 3,                   Address offset: 0x94 */
...
typedef struct
{
	__VO uint32_t PCR4;       /*!< PC Card  control register 4,                       Address offset: 0xA0 */
	__VO uint32_t SR4;        /*!< PC Card  FIFO status and interrupt register 4,     Address offset: 0xA4 */
	__VO uint32_t PMEM4;      /*!< PC Card  Common memory space timing register 4,    Address offset: 0xA8 */
	__VO uint32_t PATT4;      /*!< PC Card  Attribute memory space timing register 4, Address offset: 0xAC */
	__VO uint32_t PIO4;       /*!< PC Card  I/O space timing register 4,              Address offset: 0xB0 */
} FSMC_Bank4_TypeDef;
...
typedef struct
{
	__VO uint32_t KR;   /*!< IWDG Key register,       Address offset: 0x00 */
	__VO uint32_t PR;   /*!< IWDG Prescaler register, Address offset: 0x04 */
	__VO uint32_t RLR;  /*!< IWDG Reload register,    Address offset: 0x08 */
	__VO uint32_t SR;   /*!< IWDG Status register,    Address offset: 0x0C */
} IWDG_TypeDef;
...
//typedef struct
//{
//  __VO uint32_t POWER;          /*!< SDIO power control register,    Address offset: 0x00 */
//  __VO uint32_t CLKCR;          /*!< SDI clock control register,     Address offset: 0x04 */
//  __VO uint32_t ARG;            /*!< SDIO argument register,         Address offset: 0x08 */
//  __VO uint32_t CMD;            /*!< SDIO command register,          Address offset: 0x0C */
//  __I uint32_t  RESPCMD;        /*!< SDIO command response register, Address offset: 0x10 */
//  __I uint32_t  RESP1;          /*!< SDIO response 1 register,       Address offset: 0x14 */
//  __I uint32_t  RESP2;          /*!< SDIO response 2 register,       Address offset: 0x18 */
//  __I uint32_t  RESP3;          /*!< SDIO response 3 register,       Address offset: 0x1C */
//  __I uint32_t  RESP4;          /*!< SDIO response 4 register,       Address offset: 0x20 */
//  __VO uint32_t DTIMER;         /*!< SDIO data timer register,       Address offset: 0x24 */
//  __VO uint32_t DLEN;           /*!< SDIO data length register,      Address offset: 0x28 */
//  __VO uint32_t DCTRL;          /*!< SDIO data control register,     Address offset: 0x2C */
//  __I uint32_t  DCOUNT;         /*!< SDIO data counter register,     Address offset: 0x30 */
//  __I uint32_t  STA;            /*!< SDIO status register,           Address offset: 0x34 */
//  __VO uint32_t ICR;            /*!< SDIO interrupt clear register,  Address offset: 0x38 */
//  __VO uint32_t MASK;           /*!< SDIO mask register,             Address offset: 0x3C */
//  uint32_t      RESERVED0[2];   /*!< Reserved, 0x40-0x44                                  */
//  __I uint32_t  FIFOCNT;        /*!< SDIO FIFO counter register,     Address offset: 0x48 */
//  uint32_t      RESERVED1[13];  /*!< Reserved, 0x4C-0x7C                                  */
//  __VO uint32_t FIFO;           /*!< SDIO data FIFO register,        Address offset: 0x80 */
//} SDIO_TypeDef;
...
typedef struct
{
  __VO uint32_t CR;   /*!< WWDG Control register,       Address offset: 0x00 */
  __VO uint32_t CFR;  /*!< WWDG Configuration register, Address offset: 0x04 */
  __VO uint32_t SR;   /*!< WWDG Status register,        Address offset: 0x08 */
} WWDG_TypeDef;
...
typedef struct
{
  __VO uint32_t CR;  /*!< RNG control register, Address offset: 0x00 */
  __VO uint32_t SR;  /*!< RNG status register,  Address offset: 0x04 */
  __VO uint32_t DR;  /*!< RNG data register,    Address offset: 0x08 */
} RNG_TypeDef;
...
typedef struct
{
  __VO uint32_t GOTGCTL;      /*!<  USB_OTG Control and Status Register    000h*/
  __VO uint32_t GOTGINT;      /*!<  USB_OTG Interrupt Register             004h*/
  __VO uint32_t GAHBCFG;      /*!<  Core AHB Configuration Register    008h*/
  __VO uint32_t GUSBCFG;      /*!<  Core USB Configuration Register    00Ch*/
  __VO uint32_t GRSTCTL;      /*!<  Core Reset Register                010h*/
  __VO uint32_t GINTSTS;      /*!<  Core Interrupt Register            014h*/
  __VO uint32_t GINTMSK;      /*!<  Core Interrupt Mask Register       018h*/
  __VO uint32_t GRXSTSR;      /*!<  Receive Sts Q Read Register        01Ch*/
  __VO uint32_t GRXSTSP;      /*!<  Receive Sts Q Read & POP Register  020h*/
  __VO uint32_t GRXFSIZ;      /* Receive FIFO Size Register         024h*/
  __VO uint32_t DIEPTXF0_HNPTXFSIZ;   /*!<  EP0 / Non Periodic Tx FIFO Size Register 028h*/
  __VO uint32_t HNPTXSTS;     /*!<  Non Periodic Tx FIFO/Queue Sts reg 02Ch*/
  uint32_t Reserved30[2];     /* Reserved                           030h*/
  __VO uint32_t GCCFG;        /* General Purpose IO Register        038h*/
  __VO uint32_t CID;          /* User ID Register                   03Ch*/
  uint32_t  Reserved40[48];   /* Reserved                      040h-0FFh*/
  __VO uint32_t HPTXFSIZ; /* Host Periodic Tx FIFO Size Reg     100h*/
  __VO uint32_t DIEPTXF[0x0F];/* dev Periodic Transmit FIFO */
}
...
typedef struct
{
  __VO uint32_t DCFG;         /* dev Configuration Register   800h*/
  __VO uint32_t DCTL;         /* dev Control Register         804h*/
  __VO uint32_t DSTS;         /* dev Status Register (RO)     808h*/
  uint32_t Reserved0C;           /* Reserved                     80Ch*/
  __VO uint32_t DIEPMSK;   /* dev IN Endpoint Mask         810h*/
  __VO uint32_t DOEPMSK;  /* dev OUT Endpoint Mask        814h*/
  __VO uint32_t DAINT;     /* dev All Endpoints Itr Reg    818h*/
  __VO uint32_t DAINTMSK; /* dev All Endpoints Itr Mask   81Ch*/
  uint32_t  Reserved20;          /* Reserved                     820h*/
  uint32_t Reserved9;       /* Reserved                     824h*/
  __VO uint32_t DVBUSDIS;    /* dev VBUS discharge Register  828h*/
  __VO uint32_t DVBUSPULSE;  /* dev VBUS Pulse Register      82Ch*/
  __VO uint32_t DTHRCTL;     /* dev thr                      830h*/
  __VO uint32_t DIEPEMPMSK; /* dev empty msk             834h*/
  __VO uint32_t DEACHINT;    /* dedicated EP interrupt       838h*/
  __VO uint32_t DEACHMSK;    /* dedicated EP msk             83Ch*/
  uint32_t Reserved40;      /* dedicated EP mask           840h*/
  __VO uint32_t DINEP1MSK;  /* dedicated EP mask           844h*/
  uint32_t  Reserved44[15];      /* Reserved                 844-87Ch*/
  __VO uint32_t DOUTEP1MSK; /* dedicated EP msk            884h*/
}
...
typedef struct
{
  __VO uint32_t DIEPCTL; /* dev IN Endpoint Control Reg 900h + (ep_num * 20h) + 00h*/
  uint32_t Reserved04;             /* Reserved                       900h + (ep_num * 20h) + 04h*/
  __VO uint32_t DIEPINT; /* dev IN Endpoint Itr Reg     900h + (ep_num * 20h) + 08h*/
  uint32_t Reserved0C;             /* Reserved                       900h + (ep_num * 20h) + 0Ch*/
  __VO uint32_t DIEPTSIZ; /* IN Endpoint Txfer Size   900h + (ep_num * 20h) + 10h*/
  __VO uint32_t DIEPDMA; /* IN Endpoint DMA Address Reg    900h + (ep_num * 20h) + 14h*/
  __VO uint32_t DTXFSTS;/*IN Endpoint Tx FIFO Status Reg 900h + (ep_num * 20h) + 18h*/
...
typedef struct
{
  __VO uint32_t DOEPCTL;       /* dev OUT Endpoint Control Reg  B00h + (ep_num * 20h) + 00h*/
  uint32_t Reserved04;         /* Reserved                      B00h + (ep_num * 20h) + 04h*/
  __VO uint32_t DOEPINT;       /* dev OUT Endpoint Itr Reg      B00h + (ep_num * 20h) + 08h*/
  uint32_t Reserved0C;         /* Reserved                      B00h + (ep_num * 20h) + 0Ch*/
  __VO uint32_t DOEPTSIZ;      /* dev OUT Endpoint Txfer Size   B00h + (ep_num * 20h) + 10h*/
  __VO uint32_t DOEPDMA;       /* dev OUT Endpoint DMA Address  B00h + (ep_num * 20h) + 14h*/
...
typedef struct
{
  __VO uint32_t HCFG;             /* Host Configuration Register    400h*/
  __VO uint32_t HFIR;      /* Host Frame Interval Register   404h*/
  __VO uint32_t HFNUM;         /* Host Frame Nbr/Frame Remaining 408h*/
  uint32_t Reserved40C;                   /* Reserved                       40Ch*/
  __VO uint32_t HPTXSTS;   /* Host Periodic Tx FIFO/ Queue Status 410h*/
  __VO uint32_t HAINT;   /* Host All Channels Interrupt Register 414h*/
  __VO uint32_t HAINTMSK;   /* Host All Channels Interrupt Mask 418h*/
}
USB_OTG_HostTypeDef;
...
typedef struct
{
  __VO uint32_t HCCHAR;
  __VO uint32_t HCSPLT;
  __VO uint32_t HCINT;
  __VO uint32_t HCINTMSK;
  __VO uint32_t HCTSIZ;
  __VO uint32_t HCDMA;
  uint32_t Reserved[2];
}
